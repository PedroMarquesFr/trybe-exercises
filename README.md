...
- [x] **26.4**| :arrow_right: Express HTTP com Node.js
- [x] **26.5**| :arrow_right: Práticando Express
- [x] **26.6**| :arrow_right: Projeto: Crush Manager
...
- [x] **31.4**| :arrow_right: Boas práticas na escrita de testes
- [x] **31.5**| :arrow_right: Projeto: API de Blogs

### Bloco 32: Sockets

- [x] **32.1**| :arrow_right: Arquitetura de Software - Camada de View
- [x] **32.2**| :arrow_right: Sockets - TCP/UDP & NET
- [ ] **32.3**| :arrow_right: Sockets - Socket.io
