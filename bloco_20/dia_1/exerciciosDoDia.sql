...
SELECT 1 AS um, 1 AS dois, 3 as tres;
-- Escreva uma query para exibir a soma dos números 10 e 15.
SELECT 10+15 AS seila;
...
SELECT 'O Projeto', Name, 'precisou de', Hours, 'horas para ser concluido' FROM Scientists.Projects ORDER BY Name DESC;
