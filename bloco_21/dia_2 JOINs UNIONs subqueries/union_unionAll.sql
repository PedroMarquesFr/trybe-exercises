...
(SELECT first_name FROM sakila.actor LIMIT 10)
UNION
...
(SELECT first_name, last_name FROM sakila.actor LIMIT 60) -- quant que tu vai passar pro limit
UNION
(SELECT first_name, last_name FROM sakila.customer LIMIT 60) -- quant que tu vai passar pro limit
ORDER BY first_name LIMIT 15 OFFSET 45; -- quanti q o limit vai filtrar com oq passaram pra ele
 -- nesse caso agnt ta pegando exatamente a ultima pagina 45+15=60
 
 -- MUITO BOM https://www.w3schools.com/sql/exercise.asp?filename=exercise_join3